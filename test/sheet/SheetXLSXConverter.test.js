...
test('SheetXLSXConverter:import', t => {
  let c = new SheetXLSXConverter()
...
test('SheetXLSXConverter:_importWorksheetToSheet', t => {
...
<worksheet>
  ...
  let c = new SheetXLSXConverter()
  t.equal(
    c._importSheetFromWorksheet(worksheet, sharedStrings).getOuterHTML(),
    sheet
  )
  t.end()
})

test('SheetXLSXConverter:export', t => {
  let c = new SheetXLSXConverter()
  t.throws(c.export, 'SheetXLSXConverter.export() not yet implemented')
  t.end()
})
