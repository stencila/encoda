  ...
  test.each(articles)(
    ...
    async (
      ...
      try {
        ...
        const error = err as { type: string; res: { failed: any } }
       ...
       * 
       * Update 2022-11-08: pa11y tests are timing out even locally on Linux so are
       * currently skipped.
       */
      if (true || os.type() === 'Darwin' || isDocker()) return
